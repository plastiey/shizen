...
export const createHeader = (city) => {
    ...
    mainInf.classList.add('main__inf');
    ...
    searchBtn.textContent = 'ok'; //ok
    cityName.textContent = city;
    cityChange.textContent = '都市を変更する'; //change city
    cityLocation.textContent = '私の場所'; //my location
    unitsC.textContent = 'C'; //C
    unitsF.textContent = 'F'; //F
    ...
    headerCity.append(mainInf, cityName, cityInner);
